...
<p align="center">
  <img src="./assets/lan-share.png" width="100%" alt="同桌的共享便签、文件上传、文件下载和局域网二维码界面">
</p>
...
在共享便签中编辑内容，点击 **保存并同步**。点击 **复制文字** 可以复制文本框中的全部内容；点击 **清空** 只会清空当前文本框，再次保存后才会同步空内容。
